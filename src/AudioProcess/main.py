...
>>>>>>> bf5bb302c46dc43e1465eedb8731b58cc693a42e
def read(f):
		if f[-1] == "3":
...
ratey, y = read('../../res/skin4/normal-hitnormal.wav')
rate, z = read('../audio.mp3')
rateM, m = read('../miss1.wav')
ratesb, b = read('../../res/skin4/spinnerbonus.wav')
ratesc, c = read('../../res/skin4/spinnerspin.mp3')
rateS, s = read('../../res/skin4/normal-hitnormal.wav')

spinSound = AudioSegment.from_mp3("../../res/skin4/spinnerspin.mp3")
slider12 = AudioSegment.from_wav('../../res/skin4/normal-hitnormal.wav')
...
def cut_audio():
	...
	f = float(o.read())
	f = int(f)
	offset = my_info[0].time - f
	newaudio = z[int(offset / 1000 * rate):]
	o.close()
	return newaudio

write('z.mp3', rate, cut_audio())
>>>>>>> bf5bb302c46dc43e1465eedb8731b58cc693a42e
end=time.time()
print(end-start)
